...
class PosMLP_Video_32(nn.Module):
    """ PosMLP_Video
    """
    ...
    def __init__(self, cfg):
        ...
        segment_dim = cfg.POSMLP_VIDEO.SEGMENT_DIM
        t_stride = cfg.POSMLP_VIDEO.T_STRIDE
        mlp_ratios = cfg.POSMLP_VIDEO.MLP_RATIOS
        embed_dims = cfg.POSMLP_VIDEO.EMBED_DIMS
        patch_size = cfg.POSMLP_VIDEO.PATCH_SIZE
        qkv_bias = cfg.POSMLP_VIDEO.QKV_BIAS
        qk_scale = cfg.POSMLP_VIDEO.QKV_SCALE
        attn_drop_rate = cfg.POSMLP_VIDEO.ATTENTION_DROPOUT_RATE
